                                ...
                                <form method="POST" action= "{{ route('consulta.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-6">
                                        <div class="font-robo form-group">
                                            ...
                                            <input class="form-control border-radius-sm" id="paciente_id" name="paciente_id" placeholder="Ingrese Número Identidad"
                                                minlength="3" maxlength="100" required value="{{ old('paciente_id') }}">
                                            @error('paciente_id')
                                    ...
                                    <div class="col-4">
                                        <div class="font-robo form-group" style="margin-bottom: 5px">
                                            ...
                                            <input class="form-control border-radius-sm" type="date"
                                                ...
                                                id="fecha_visita" value="{{ old('fecha_visita') }}"
                                    ...
                                    <div class="col-6">
                                        <div class="font-robo form-group">
                                            ...
                                            <textarea class="form-control border-radius-sm" id="motivo_visita" name="motivo_visita" placeholder="Ingrese motivo"
                                                minlength="3" maxlength="100" required>{{ old('motivo_visita') }}</textarea>
                                            @error('motivo_visita')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
