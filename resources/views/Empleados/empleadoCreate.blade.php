                ...
                <div class="card-body border-radius-sm border-0">
                    <form method="POST" action="{{route("empleado.store")}}" enctype="multipart/form-data">
                            ...
                            <div class="col-4">
                                <div class="font-robo form-group" style="margin-bottom: 5px">
                                    ...
                                    <input class="form-control border-radius-sm" type="number"
                                        ...
                                        value="{{ old('dni') }}" min="0" minlength="13" maxlength="13" size="13">
                                    @error('dni')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-4">
                                <div class="font-robo form-group" style="margin-bottom: 5px">
                                    ...
                                    <input class="form-control border-radius-sm" type="date"
                                        ...
                                        value="{{ old('fecha_de_nacimiento') }}" max={{ now() }} required>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="font-robo form-group">
                                    ...
                                    required>{{old('procedencia')}}</textarea>
                                    @error('procedencia')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                </div>
                                ...
                                <div class="font-robo form-group">
                                    ...
                                    <select name="Rh" id="Rh" class="form-control form-select" required>
                                        @if (old('Rh'))
                                            ...
                                            @endif
                                        @else
                                            <option disabled="disabled" selected="selected" class="" value="">-- Seleccione --</option>
                                        @endif
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="font-robo form-group">
                                    ...
                                    name="enfermedades" id="enfermedades" minlength="3" maxlength="50">{{old('enfermedades')}}</textarea>
                                    @error('enfermedades')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="font-robo form-group">
                                    ...
                                    name="medicamentos" id="medicamentos" minlength="3" maxlength="80">{{old('medicamentos')}}</textarea>
                                    @error('medicamentos')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                </div>
                        ...
                        <div style="float: right;margin-top: 5px">
                            ...
                            <a type="reset" href={{ route('empleado.create') }} class="btn btn-warning"><i class="fas fa-eraser"></i> Limpiar </a>
                    ...
                    <div class="modal fade" id="cancelarB" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <a type="button" href={{ route('empleado.index') }} class="btn btn-danger">Si</a>
                            </div>
                        </div>
                        </div>
                    </div>
